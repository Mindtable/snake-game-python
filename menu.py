...
def shop(screen, GAME_ZONE_W, SCREEN_HEIGHT, FPS, clock):
	global active_zone
	done = False
	...
	while not done:
			...
			if event.type == pygame.KEYDOWN:
				...
				if keystate[pygame.K_RETURN]:
					if active_zone[1] == SCREEN_HEIGHT/2-40:
						...
						return False
					if active_zone[1] == SCREEN_HEIGHT / 2 + 40:
						shop(screen, GAME_ZONE_W, SCREEN_HEIGHT, FPS, clock)
				if keystate[pygame.K_BACKSPACE] or keystate[pygame.K_ESCAPE]:
					menu_screen(screen, GAME_ZONE_W, SCREEN_HEIGHT, FPS, clock)
		...
		screen.blit(skin1, (20, SCREEN_HEIGHT / 2 - 80))
		screen.blit(skin2, (20, SCREEN_HEIGHT / 2 - 40))
		screen.blit(skin3, (20, SCREEN_HEIGHT / 2))
		screen.blit(skin4, (20, SCREEN_HEIGHT / 2 + 40))
		screen.blit(ultimate_skin, (20, SCREEN_HEIGHT / 2 + 80))

		pygame.draw.rect(screen, (255, 255, 0), [250, SCREEN_HEIGHT / 2 - 78, 20, 20])
		pygame.draw.rect(screen, (0, 255, 0), [250, SCREEN_HEIGHT / 2 - 38, 20, 20])
		pygame.draw.rect(screen, (0, 250, 175), [250, SCREEN_HEIGHT / 2 + 2, 20, 20])
		pygame.draw.rect(screen, (255, 40, 0), [250, SCREEN_HEIGHT / 2 + 42, 20, 20])

		screen.blit(prise1, (300, SCREEN_HEIGHT / 2 - 80))
		screen.blit(prise2, (300, SCREEN_HEIGHT / 2 - 40))
		screen.blit(prise3, (300, SCREEN_HEIGHT / 2))
		screen.blit(prise4, (300, SCREEN_HEIGHT / 2 + 40))
		screen.blit(ultimate_prise, (300, SCREEN_HEIGHT / 2 + 80))

		pygame.draw.rect(screen, (255, 255, 255), [0, 0, GAME_ZONE_W, SCREEN_HEIGHT], width=1)
		pygame.draw.rect(screen, (255, 255, 255), [GAME_ZONE_W + 20, 0, 230, SCREEN_HEIGHT], width=1)

		pygame.draw.rect(screen, white, [active_zone[0], active_zone[1], 450, 30], width=1)
	...
	while not done:
		...
		for event in pygame.event.get():
			...
			if event.type == pygame.KEYDOWN:
				...
				if keystate[pygame.K_RETURN]:
					if active_zone[1] == SCREEN_HEIGHT/2-40:
						game_process.game_process(surface, GAME_ZONE_W, SCREEN_HEIGHT, FPS, clock)
					if active_zone[1] == SCREEN_HEIGHT / 2 + 40:
